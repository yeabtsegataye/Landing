...
import imgphone from "../../public/assets/img/menu.png"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="text-gray-600">
          Customers can effortlessly scan a QR code to access your digital menu,
          browse food options, and place orders directly from their devices.
        </p>
      </div>
      ...
      >
        ...
        <p className="text-gray-600">
          Reduce wait times and improve customer satisfaction with a streamlined
          ordering process.
        </p>
      </div>
    </div>
...
<section id="about" className="py-16 bg-white">
  ...
  <div className="container mx-auto px-4 text-center mb-12" data-aos="fade-up">
    ...
    <p className="text-gray-600 mt-4">
      Automate and simplify your operations, saving time and reducing errors
    </p>
  </div>
  {/* End Section Title */}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      >
        ...
        <p className="text-gray-600 italic mb-4">
          We’ve developed a cutting-edge Hotel Order and Finance Management
          System designed to streamline operations, enhance customer experience,
          and empower business owners with real-time insights. Our system is the
          ultimate all-in-one solution for modern hospitality businesses.
        </p>
        <ul className="space-y-4 mb-4">
          <li className="flex items-start">
            <i className="bi bi-check2-all text-blue-600 text-xl mr-2"></i>
            <span className="text-gray-600">
              Gain actionable insights into your business performance with live
              data on daily revenue, food sales, and customer trends.
            </span>
          </li>
          <li className="flex items-start">
            <i className="bi bi-check2-all text-blue-600 text-xl mr-2"></i>
          ...
          <li className="flex items-start">
            <i className="bi bi-check2-all text-blue-600 text-xl mr-2"></i>
            <span className="text-gray-600">
              Access and analyze customer comments and reviews to continuously
              improve your services.
            </span>
          </li>
        </ul>
        <p className="text-gray-600">
          Track sales performance by day, week, or month to identify trends and
...
<section id="portfolio" className="py-16 bg-gray-50">
  ...
  <div className="container mx-auto px-4 text-center mb-12" data-aos="fade-up">
    ...
    <p className="text-gray-600 mt-4">
      Take control of your hotel, café, or restaurant operations with REVE IT Solutions.
    </p>
  </div>
  {/* End Section Title */}
        ...
        >
          ...
          >
            ...
            <div className="text-4xl font-bold text-gray-800 mb-4">
              ...
              {plan.price}
              <span className="text-sm text-gray-600">/{plan.sub_date} month</span>
            </div>
            ...
            <ul className="text-gray-600 mb-6 space-y-2">
              {plan.features.map((feature, i) => (
                <li key={i} className="flex items-center justify-start ml-4">
...
<section id="contact" className="py-16 bg-gray-50">
  {/* Section Title */}
  <div className="container mx-auto px-4 text-center mb-12" data-aos="fade-up">
    <h2 className="text-3xl font-bold text-gray-800 mt-2">Contact us today</h2>
    <p className="text-gray-600 mt-4">
    ...
    <div className="flex flex-wrap justify-center -mx-4">
      ...
      >
        <div className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-gray-600">Addis Abeba, Bole, Atlas Main Road</p>
        </div>
      </div>
